const Button = ({value, paddingX="40px", paddingY="16px", bg="#FF624C", color="white", border=false, borderColor="#FF624C", width="auto", handleLoadMore, signOut, handleUpdateCart, handleSubmit}) => {
    return (
