...
const ProductLayout = ({ discountTag = false, category, title, rating = 1, totalRatings, price }) => {
    ...
    return (
        <div className="p-6 group cursor-pointer border border-transparent hover:border-[#C3C3C3] rounded-[10px] max-w-[285px]">
            ...
            <div className="mt-10">
                ...
                <h3 className="text-[#303030] font-['Poppins'] text-xl font-semibold leading-[30px] max-w-[237px] mt-4 group-hover:text-[#FF624C] group-hover:underline transition duration-100">{title}</h3>
                ...
                <p className="text-[#303030] font-['Poppins'] text-2xl font-semibold leading-[30px] mt-5">${price}</p>
            </div>
        </div>
    );
};
