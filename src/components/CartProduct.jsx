    ...
    return (
        <div className="h-[294px] flex items-center rounded-[10px] border border-[transparent] transition px-[36px] py-[24px] group relative hover:border-[#CBCBCB]">
            ...
            <div className="w-[50%] flex items-center gap-[62px]">
                ...
                <div>
                    <p className="text-[#303030] font-['Montserrat'] text-sm leading-5 uppercase">L A P T O P</p>
                    <h4 className="text-[#303030] font-['Poppins'] text-xl font-semibold leading-[30px] max-w-[314px] mt-4 group-hover:text-[#FF624C] group-hover:underline group-hover:decoration-2">2019 Smart Laptop 256 GB 13 inch Pro Chip Core 1 TB HD SSD</h4>
            ...
            {/* Price Part */}
            <div className="text-[#303030] w-[16.5%] font-['Poppins'] text-xl font-semibold leading-[30px]">$1,659.00</div>
