        ...
        <div>
            ...
            <form onSubmit={handleSubmit} className="md:w-[870px] flex flex-col xl:flex-row xl:flex-wrap justify-between gap-y-4 sm:gap-y-8 mt-10 mb-8">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <input className="py-4 md:py-[25px] px-6 sm:px-[32px] outline-none border border-[#CBCBCB] rounded-[10px] w-[360px] sm:w-[80%] xl:w-[345px] text-[#303030] placeholder:text-[#303030] placeholder:opacity-75 font-['Montserrat'] md:text-xl leading-[30px]" type="text" id="number" placeholder="+123 456 7890" />
                </div>
                {/* Email Address */}
                <div className="flex flex-col gap-3">
                    ...
                    <input className="py-4 md:py-[25px] px-6 sm:px-[32px] outline-none border border-[#CBCBCB] rounded-[10px] w-[360px] sm:w-[80%] xl:w-[510px] text-[#303030] placeholder:text-[#303030] placeholder:opacity-75 font-['Montserrat'] md:text-xl leading-[30px]" type="email" id="email" placeholder="amelia.watson@eshop.com" />
                </div>
                {/* Message */}
                <div className="flex flex-col gap-3">
