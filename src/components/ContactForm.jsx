        ...
        <div>
            ...
            <div className="w-[870px] flex flex-wrap justify-between gap-y-8 mt-10 mb-8">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <input className="py-[25px] px-[32px] outline-none border border-[#CBCBCB] rounded-[10px] w-[870px] text-[#303030] font-['Montserrat'] text-xl leading-[30px]" type="text" id="name" placeholder="Amelia Robert Watson" />
                </div>
                {/* Phone Number */}
                <div className="flex flex-col gap-3">
                    <label className="text-xl text-[#303030] font-['Montserrat'] font-bold leading-[30px]" htmlFor="number">Phone Number</label>
                    <input className="py-[25px] px-[32px] outline-none border border-[#CBCBCB] rounded-[10px] w-[345px] text-[#303030] font-['Montserrat'] text-xl leading-[30px]" type="text" id="number" placeholder="+123 456 7890" />
                </div>
                {/* Email Address */}
                <div className="flex flex-col gap-3">
                    ...
                    <input className="py-[25px] px-[32px] outline-none border border-[#CBCBCB] rounded-[10px] w-[510px] text-[#303030] font-['Montserrat'] text-xl leading-[30px]" type="email" id="email" placeholder="amelia.watson@eshop.com" />
                </div>
                {/* Message */}
                <div className="flex flex-col gap-3">
                    ...
                    <textarea className="py-[25px] px-[32px] outline-none border border-[#CBCBCB] rounded-[10px] w-[870px] h-[241px] resize-none text-[#303030] font-['Montserrat'] text-xl leading-[30px]" id="message" placeholder="Your message here..." rows="4"></textarea>
                </div>
            </div>
