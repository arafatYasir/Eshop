    ...
    return (
        <div className="bg-white rounded-[25px] py-5 pl-[40px] sm:py-[34px] sm:pl-[112px] sm:pr-[56px] sm:w-[925px] sm:max-w-[925px] ">
            <div onClick={() => handleOpenFaq(id)} className="cursor-pointer relative">
                ...
                <p className="text-[#303030] font-['Poppins'] text-sm sm:text-2xl font-semibold leading-[30px]">{title}</p>
            </div>
            {
                isOpen && (
                    <div className="pr-8 sm:pr-0 text-justify sm:max-w-[758px] text-[#303030] font-['Montserrat'] text-[12px] sm:text-xl leading-[30px] opacity-75 sm:mt-4">
                        {description}
                    </div>
                )
            }
